...
import {createUser, getRoles, Role} from "../services/api.ts";
...
export function Signup() {
    ...
    return (
        <div style={{maxWidth: 560, margin: '24px auto', padding: 12}}>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input name="password" type="password" value={form.password} onChange={onChange} minLength={6}
                       required/>
